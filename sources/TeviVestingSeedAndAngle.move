...
module TeviVesting::SeedAndAngle {
    ...
    /// Constants specific to Seed and Angle vesting
    ...
    const VESTING_OBJECT_SEED: vector<u8> = b"TEVI_VESTING_SEED_AND_ANGLE";
    ...
    /// Initialize the seed and angle vesting contract
