module TeviVesting::TeamAndAdvisor {
    ...
    /// Constants specific to Team and Advisor vesting
    const CLIFF_MONTHS: u64 = 6;
    const TGE_BPS: u64 = 0; // 0%
    const LINEAR_VESTING_MONTHS: u64 = 60;
    ...
    const VESTING_OBJECT_SEED: vector<u8> = b"TEVI_VESTING_TEAM_AND_ADVISOR";
    ...
    /// Initialize the team and advisor vesting contract
